import 'package:tdd_boilerplate_cli/src/commands/create/commands/commands.dart';
import 'package:tdd_boilerplate_cli/src/commands/create/templates/templates.dart';

/// {@template tdd_boilerplate_create_app_command}
/// A [CreateSubCommand] for creating Flutter apps.
/// {@endtemplate}
class CreateApp extends CreateSubCommand with OrgName, MultiTemplates {
  /// {@macro tdd_boilerplate_create_app_command}
  CreateApp({
