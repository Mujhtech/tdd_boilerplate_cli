...
import 'package:tdd_boilerplate_cli/src/commands/create/templates/templates.dart';
...
const _defaultOrgName = 'com.example.tddBoilerplate';
const _defaultDescription = 'A Flutter Project created by TDD Boilerplate CLI.';
...
/// [Publishable].
abstract class MakeSubCommand extends Command<int> {
  ...
  String get invocation =>
      'tdd_boilerplate create $name <project-name> [arguments]';
...
/// Mixin for [MakeSubCommand] subclasses that receives the org name
/// parameter.
///
/// Takes care of parsing from [argResults] and validating the org name.
mixin OrgName on MakeSubCommand {
...
/// Mixin for [MakeSubCommand] subclasses that receives multiple templates.
///
...
mixin MultiTemplates on MakeSubCommand {
...
/// Mixin for [MakeSubCommand] subclasses that receives the publishable
/// flag.
///
/// Takes care of parsing it from [argResults] and pass it
/// to the brick generator.
mixin Publishable on MakeSubCommand {
